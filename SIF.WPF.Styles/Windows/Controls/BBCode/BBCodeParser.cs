...
namespace SIF.WPF.Styles.Windows.Controls.BBCode
{
    /// <summary>
        ...
        private void Parse(Span span)
        {
            ...
            while (true) {
                ...
                if (token.TokenType == BBCodeLexer.TokenStartTag) {
                    ...
                    throw new ParseException(SIF.WPF.Styles.Resources.UnexpectedToken);
                }
                else if (token.TokenType == BBCodeLexer.TokenEnd) {
                    break;
                }
                else {
                    throw new ParseException(SIF.WPF.Styles.Resources.UnknownTokenType);
                }
            }
        }
