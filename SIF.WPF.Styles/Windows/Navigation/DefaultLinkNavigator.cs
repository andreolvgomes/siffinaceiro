...
using SIF.WPF.Styles.Windows.Media;
using System;
        ...
        public virtual void Navigate(Uri uri, FrameworkElement source = null, string parameter = null)
        {
            ...
            if (this.commands != null && this.commands.TryGetValue(uri, out command)) {
                ...
                if (source == null) {   // source required
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, SIF.WPF.Styles.Resources.NavigationFailedSourceNotSpecified, uri));
                }
                ...
                if (frame == null) {
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, SIF.WPF.Styles.Resources.NavigationFailedFrameNotFound, uri, parameter));
                }
