...
namespace EditorSQL
{
    public class SqlParagraphProcessor : IParagraphProcessor
    {
        ...
        private static readonly HashSet<string> _keyWords2 = new HashSet<string>(StringComparer.CurrentCultureIgnoreCase)
        {
            "INNER",
            "JOIN",
        };

        private static readonly HashSet<string> _keyWords = new HashSet<string>(StringComparer.CurrentCultureIgnoreCase)
                {
                    "ADD",
                    "ALL",
                    "ALTER",
