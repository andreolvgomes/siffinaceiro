...
namespace EditorSQL
{
    public class SourceCodeEditor : RichTextBox
    {
        ...
        private IParagraphProcessor _paragraphProcessor = new SqlParagraphProcessor();

        public SourceCodeEditor()
        {
            this.Document.PageWidth = 30000;
        ...
        private void SetLongText(string text)
        {
            ...
            foreach (var line in lines)
            {
                ...
                this.EvaluateParagraph(p, new List<string>(this._paragraphProcessor.SplitWordsRegex.Split(line)));
            }
