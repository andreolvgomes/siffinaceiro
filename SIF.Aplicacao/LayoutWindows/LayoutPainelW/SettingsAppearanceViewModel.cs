...
namespace SCPAplicacao.Layouts
{
    /// <summary>
    ...
    public class SettingsAppearanceViewModel : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "bing image", Source = new Uri("/SCPAplicacao;component/Fundo/ModernUI.BingImage.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "hello kitty", Source = new Uri("/SCPAplicacao;component/Fundo/ModernUI.HelloKitty.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "love", Source = new Uri("/SCPAplicacao;component/Fundo/ModernUI.Love.xaml", UriKind.Relative) });
            this.themes.Add(new Link { DisplayName = "snowflakes", Source = new Uri("/SCPAplicacao;component/Fundo/ModernUI.Snowflakes.xaml", UriKind.Relative) });
