        ...
        public virtual void Navigate(Uri uri, FrameworkElement source = null, string parameter = null)
        {
            ...
            if (this.commands != null && this.commands.TryGetValue(uri, out command)) {
                ...
                if (source == null) {   // source required
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, FirstFloor.ModernUI.Resources.NavigationFailedSourceNotSpecified, uri));
                }
                ...
                if (frame == null) {
                    throw new ArgumentException(string.Format(CultureInfo.CurrentUICulture, FirstFloor.ModernUI.Resources.NavigationFailedFrameNotFound, uri, parameter));
                }
